...
| 18 | **NARROWED** | Every gate measures whether a level WORKS. None measures whether it is | 2026-09-11 -- A PERSON WALKED A SHIPPED PACKAGE, WHICH IS THE WHOLE ASK, AND EIGHT THINGS  |
...
**144 items: 28 open, 77 closed, 3 retracted, 31 narrowed, 1 superseded, 4 analysis.** 6 rest on a sentence rather than a status line -- run `roadmap_status.py --unclassified` for the list.
...
*STATUS: NARROWED 2026-09-11 -- A PERSON WALKED A SHIPPED PACKAGE, WHICH IS
