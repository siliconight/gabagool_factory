...
| 17 | **NARROWED** | The pipeline has never been run cold, so nobody knows what it costs to | 2026-09-13 (midday) -- 9038 AND 9040 SCORED ZERO; 9039 WAS REFUSED BY THE CLOSURE GATE, CO |
...
| 45 | **NARROWED** | Large playable surfaces are visually flat, and the fix is not more gra | 2026-09-13 (midday) -- THE GROUND STOPPED READING AS PAVING, AND THE DIAGNOSIS THAT GOT TH |
...
| 144 | **NARROWED** | The stairs ship in the greybox's fallback yellow | 2026-09-11 (evening) -- 0.72.0 REFUTED ON THE FIRST COLD EXPORT AND REPLACED BY 0.72.1, ME |
...
*STATUS: NARROWED 2026-09-11 -- THE HYPOTHESIS IS REFUTED AND THE CAUSE IS
...
COPY; NOT YET RE-EXPORTED OR RE-WALKED. `zoo_worldskin.gd` runs a second pass on `site_base*.glb` --
