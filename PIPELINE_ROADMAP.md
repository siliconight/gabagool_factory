...
| 17 | **NARROWED** | The pipeline has never been run cold, so nobody knows what it costs to | 2026-09-13 (night) -- COLD RUN 9032 SCORED ZERO WITH THE CROWN READING AS A CANOPY. The ba |
...
| 153 | **NARROWED** | A street reads as ordered when its furniture says where cars and peopl | 2026-09-13 (night) -- THE CROWN READS AS A CANOPY (9032): ONE FOLIAGE TILE PER CARD, THE C |
